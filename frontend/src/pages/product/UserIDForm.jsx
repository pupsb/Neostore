...
const UserIDForm = () => {
  ...
  return (
    <>
      <div className="py-[1.5em] px-[2em] bg-[#FFFFFF] dark:bg-dark-bg-card flex flex-col items-center rounded-[1em] w-full transition-colors duration-300">
        <div className="flex items-center text-[#E11D48] dark:text-dark-accent-primary font-[500]">

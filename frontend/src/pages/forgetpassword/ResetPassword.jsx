          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              {error ? <span className='text-[#E72929] mt-[-13px] text-[0.9rem] '>{error}
                {error === "The link is corrupted." && <a href="/forgetpassword" className="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500"> Regenerate Link</a>}
              </span> : <></>}

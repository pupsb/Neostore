      ...
      {!isLoading && (
        <>
          ...
          <Routes>
            ...
            <Route path="/otpverify/:mobile" element={
              <>
                <OtpVerify />
              </>
            }
            ...
            <Route path="/balanceerror" element={
              <>
                <BalanceErr />
              </>
            }
            ...
            <Route path="/walletconfirmation" element={
              <>
                <WalletConfirmation />
              </>
            }
            ...
            <Route path="/checkverification" element={
            ...
            <Route path="/verification/:id/:token"
            ...
            <Route
              ...
              element={
                <ProtectedRoute
                  element={<AdminPage />}
                  requiredRoles={["admin"]} // Only allow admin
                />
              }
            />
          </Routes>

  ...
  return (
    <div className="md:w-[16%] lg:w-[18%] w-[115px] max-w-[250px] flex-shrink-0 h-[180px] md:h-[240px]">
      <a
        ...
        className="relative rounded-[1em] flex items-center text-center flex-col mt-[30px] px-[8px] pt-[33px] pb-[8px] bg-[#fff] h-full "
      ...
      >
        ...
        <div className="grow-1  w-full md:mt-4  flex flex-col justify-around h-full">
          <div>
          <div className="overflow-hidden text-[#E11D48] md:text-[1.3rem] text-[1rem] md:mt-3">{data.name}</div>
          <div className="h-[3em] md:text-[1.5rem] text-[1rem] font-[800] text-black line-clamp-2">Discount</div>
          </div>

          <div className="w-full md:mt-auto ">
            <div className="text-[#fff] bg-[#E11D48] p-[3px]  rounded-full mb-0 mx-3 hover:bg-[#E11D84] hover:text-white text-[0.9rem] md:text-[1.0rem]"  style={{border: "1px solid #fff"}}>TOP UP</div>
          </div>
        </div>
      </a>
    </div>

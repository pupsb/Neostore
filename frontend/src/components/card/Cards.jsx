      ...
      >
        ...
        <div className="grow-1  w-full md:mt-4  flex flex-col justify-around h-full">
          ...
          <div className="w-full md:mt-auto ">
            <div className={`p-[3px] rounded-full mb-0 mx-3 text-[0.9rem] md:text-[1.0rem] border ${!data.instock ? 'text-white bg-gray-400 dark:bg-gray-600 border-gray-400 dark:border-gray-600 cursor-not-allowed' : 'text-[#fff] bg-[#E11D48] dark:bg-[#B4FF39] dark:text-[#0A0E13] hover:bg-[#E11D84] dark:hover:bg-[#7FBF3D] hover:text-white transition-colors border-white dark:border-[#B4FF39]'}`}>TOP UP</div>
          </div>
        </div>
      </a>
    </div>
